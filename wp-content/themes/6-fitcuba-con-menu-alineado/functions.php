...
function devolver_titulo($patron, $title) {
    global $wpdb;
$title1=split($patron, $title);
$long=sizeof($title1);
if($long=='1')
{
$title3=$title;
...
{
$title2=split(":", $title1[1]);
$title3=str_replace('[',' ',$title2[0]);
}
return $title3;
}

function devolver_contenido($patron, $cont) {
    global $wpdb;
$cont1=split($patron, $cont);
$long=sizeof($cont1);
if($long=='1')
{
$cont3=$cont;
...
{
$cont2=split(":", $cont1[1]);
$cont3=str_replace('[',' ',$cont2[0]);
}
$cont4=getSubString($cont3, 195); 
// $cont5= str_replace_once('</strong>', '</strong></br>', $cont4);
return $cont4;
}
...
function getSubString($string, $length=NULL)
{
    ...
    $stringDisplay = substr(strip_tags($string, '<strong>'), 0, $length);
