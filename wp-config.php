...
define('DB_NAME', 'fitcuba_db');

/** Tu nombre de usuario de MySQL */
// define('DB_USER', 'fitcuba');
define('DB_USER', 'fitcuba_usr');

/** Tu contraseña de MySQL */
// define('DB_PASSWORD', '8qfcezUVsSmzJmZw');
define('DB_PASSWORD', '7ZE9PNHKFrebD2CC');

/** Host de MySQL (es muy probable que no necesites cambiarlo) */
// define('DB_HOST', '192.168.1.26');
define('DB_HOST', '192.168.14.76');

/** Codificación de caracteres para la base de datoss. */
